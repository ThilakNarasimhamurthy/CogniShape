    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Join the autism screening revolution
        </p>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <select
                  id="role"
                  className={`input pl-10 ${errors.role ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''}`}
                  {...register('role', { required: 'Please select account type' })}
                >
                  <option value="">Select account type</option>
                  <option value="parent">Parent (10 children)</option>
                  <option value="doctor">Healthcare Professional (25 patients)</option>
                </select>
              </div>
              {errors.role && (
